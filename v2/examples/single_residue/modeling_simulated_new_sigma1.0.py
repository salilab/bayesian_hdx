...
outputdir="./sim_output_s1.0"

####### Input Parameters #######
offset=0        # offset between fragment start/end values and FASTA sequence
sigma0=1.0        # Estimate 4or slope of experimental error (slope of sd vs. %D plot)
num_exp_bins=1001   # Number of bins
annealing_steps=200
inseq="AAA"
