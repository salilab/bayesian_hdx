...
class ResidueGridModel(object):
    ...
    def calculate_protection_factor_grids(self, threshold = 0.01):
        ...
        # For each dataset, get the observable protection factors for each residue
        observable_pfs = []
    ...
    def change_residue(self, residue, value):
        #print(value, len(self.model), len(self.model_protection_factors), len(self.pf_grids), len(self.pf_grids[residue-1]))
